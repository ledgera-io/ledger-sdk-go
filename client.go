...
// APIClient manages communication with the Ledgera core API API v2.0
...
type APIClient struct {
	...
	BillingPlanLedgera *BillingPlanLedgeraService

	TransactionLedgera *TransactionLedgeraService

	TransactionRuleLedgera *TransactionRuleLedgeraService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.TransactionRuleLedgera = (*TransactionRuleLedgeraService)(&c.common)
